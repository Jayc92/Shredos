    ...
    <Card variant="status" className="gap-0 py-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        <div className="bg-surface-sunken rounded-lg px-2 py-2.5 text-center">
          ...
          <p className="text-xs text-ink-muted mt-0.5">avg cal/day</p>
        </div>
        <div className="bg-surface-sunken rounded-lg px-2 py-2.5 text-center">
          <p className="text-base font-bold tabular-nums">
            {summary.avgProteinLast7 !== null ? `${summary.avgProteinLast7}g` : '—'}
          </p>
          <p className="text-xs text-ink-muted mt-0.5">avg protein</p>
        </div>
      </div>
      ...
      {summary.weightTrend !== 'insufficient-data' &&
        summary.weeklyWeightChangeLbs !== null && (
          <div className="flex items-center justify-between border-t border-edge-subtle pt-2.5">
      ...
      {summary.calorieSuggestion && (
        <div className="bg-blue-500/5 border border-blue-500/20 rounded-lg px-3 py-2.5">
          ...
          <p className="text-xs text-ink-muted mt-1.5">
            ...
            <a href="/nutrition" className="text-brand hover:underline">
              Nutrition settings
            </a>
            .
          </p>
