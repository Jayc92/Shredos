...
| C | `docs/weight-time-five-entry-run-authority-form.json` | 1 | run_key_literal, product approver + timestamp, legal approver + timestamp, approval_rationale, run_membership |
...
- **RQ-8** (family C): the sealed plank run stays sealed; the intent is to ADD a second sealed run and
  later repoint delivery to it, not to revoke the plank run.
...
- authored_by: ForgeFitOS content program (AI-drafted original prose; pending human specialist review); authored_at: 2026-09-11
- content payload fingerprint: `7008e7faa08908d3aad56a76ab9dd600a47cd0b098b409b57ed54798ac362bb0`
...
3. Choose a plate you could hold for at least half your unweighted plank time; the added load raises the difficulty and does not replace the position.
...
Breathing cue: Take smaller breaths than usual and keep them continuous through the hold; never hold your breath to brace, because a long hold needs steady airflow.
...
- Reaching for a heavier plate before the unweighted hold is solid, so the position fails before the trunk is actually challenged.
...
- authored_by: ForgeFitOS content program (AI-drafted original prose; pending human specialist review); authored_at: 2026-09-11
- content payload fingerprint: `9ca1a52048ed2f8d3ab51453c6684a1dfb5007541101edecea1c6dc458009694`
...
3. Choose a vest load you could hold for at least half your unweighted plank time, and check that the weight is even front to back.
...
Breathing cue: Take smaller breaths than usual and keep them continuous; a snug vest limits how far the ribcage can expand, so do not brace by holding your breath.
...
- authored_by: ForgeFitOS content program (AI-drafted original prose; pending human specialist review); authored_at: 2026-09-11
- content payload fingerprint: `6bb9d0783c669fdf36a86229fcdbe3b9c34c4093fbb1ee1870872d80bc074fea`

Setup:

1. Attach the weight to a dipping belt around your hips, or set a plate to hold between your feet, before you reach for the bar.
...
Breathing cue: Breathe steadily and evenly through the hang; holding your breath to squeeze the bar ends the hold well before your grip actually gives out.
...
- Adding weight before an unweighted hang is comfortable for a full minute.
...
Equipment setup: A secure pull-up bar rated for your bodyweight plus the added load, and a dipping belt with a weight plate, or a plate held securely between the feet.
...
- authored_by: ForgeFitOS content program (AI-drafted original prose; pending human specialist review); authored_at: 2026-09-11
- content payload fingerprint: `e7c49468df9de0c5c6ab26b0acfc1a20256a167a928d2da8ce7cb059213e1c39`
...
2. Check that your knees sit above your heels rather than ahead of your toes, and that your whole back stays against the wall.
...
Breathing cue: Keep breathing evenly the whole way through; the burn will tempt you to hold your breath, which ends the hold sooner than your legs would.
...
- Letting the knees travel forward past the toes, which moves the effort off the thighs.
...
- authored_by: ForgeFitOS content program (AI-drafted original prose; pending human specialist review); authored_at: 2026-09-11
- content payload fingerprint: `98ffeb222d2514a8c338ba85bae4cbb9b67769a0760261a756c1d399647573cd`
...
3. Check that your knees sit above your heels and that the vest is not bunched between your back and the wall.
...
Breathing cue: Breathe evenly and continuously; a snug vest restricts the ribcage, so a held breath will end the hold before your legs do.
...
- Letting the knees drift forward past the toes as fatigue sets in.
...
Equipment setup: A flat wall and a weighted vest with secured, evenly distributed pockets. Because the hands stay free, a vest suits longer holds than a plate held on the thighs.
...
- run_membership: the one offered choice, `ALL_FIVE_WEIGHT_TIME_IDENTITIES`.
