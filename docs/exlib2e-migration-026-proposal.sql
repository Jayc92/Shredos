-- ============================================================
-- EXLIB-2E PROPOSAL: migration 026 (DRAFT — NOT APPLIED)
-- Plank seed reconciliation implementation
--
-- STATUS: IMPLEMENTATION PROPOSAL ONLY. This file lives in docs/,
-- NOT in supabase/migrations/, precisely because it has NOT been
-- approved for application. It must never be applied to any hosted
-- environment; only Joseph/ChatGPT may ever apply migrations, and
-- only after this proposal passes review and is moved into
-- supabase/migrations/ by an explicitly authorized later phase.
--
