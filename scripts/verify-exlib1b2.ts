...
async function main() {
  console.log('\nA. Inventory, fingerprints, revision record')
  {
    ...
    check('A1: migrations are exactly 001-024; 023 and the 024 draft have the pinned filenames',
      ...
      // w11Migration028Admitted) becomes exactly-28 with 028 pinned at index 27 by filename and fingerprint.
      ...
      files.length === 29 && w11Migration028Admitted() && w14eMigration029Admitted() && files[27] === W11_M028 && files[28] === W14E_M029 &&
