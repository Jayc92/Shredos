...
async function main() {
  ...
  console.log('\n5. Boundaries')
  {
    ...
    // RETARGET (UI-5B1B): 021_ui5b_transactional_ordering.sql is the approved transactional-ordering migration.
    // RETARGET (UI-5B2): original boundary — nothing beyond the
    // approved 021 could exist. 022_ui5b2_workout_reuse.sql is the
    // approved UI-5B2 workout-reuse migration; it becomes the new
    // ceiling and nothing beyond it may appear.
    check('S71: no migration beyond 020 except the approved 021 and 022',
