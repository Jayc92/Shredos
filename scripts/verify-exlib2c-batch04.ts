...
async function main(): Promise<void> {
  ...
  console.log('\nA. Baseline and phase boundary')
  {
    ...
    check('A2: planning-only boundary — migration 026 absent, migrations exactly 001-025, zero weight_time in src, no importer artifacts, and the range beyond the Batch 3 tip touches ONLY this phase\'s five paths',
      (() => {
