...
async function main(): Promise<void> {
  ...
  {
    check('C1: seed, inventory, ledger, and legacy eligibility held byte-identical through this milestone (delivery paths anchored at the delivery predecessor); seed_link_compatible remained false; the six batch corpora stay byte-frozen with every record import_eligible=false (R6\'s batch scope untouched)',
      (() => {
